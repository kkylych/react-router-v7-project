    ...
    <div className="p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <input
          ...
          value={search}
          className="border border-gray-300 rounded px-3 py-2 w-full sm:w-1/2 focus:border-indigo-500"
        />
        <select
          value={region}
          ...
          {filteredCountries.map((country: any, key: number) => (
            ...
            >
              <Link
                ...
                className="text-indigo-600 hover:undeline text-lg font-semibold"
              >
                {country.name.common}
              </Link>
